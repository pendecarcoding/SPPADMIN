            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <script>
                  ...
                  function(){   swal("data dihapus!", "", "success")
                      window.location = '{{url("deletejenispengeluaran")}}/'+id;
        ...
        <div class="box">
          <div class="box-header">
            <div class="main-sparkline16-hd">
                <center><h3>Tambah Jenis Pengeluaran</h3></center>
                <hr>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="sparkline16-graph">
                            <form class="forms-sample" action="{{url('/tambahjenispengeluaran')}}" method="post">{{csrf_field()}}
