        ...
        <div class="box">
          <div class="box-header">
            <div class="main-sparkline16-hd">
                <center><h3>Tambah Data Pengeluaran</h3></center>
                <hr>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="sparkline16-graph">
                              <form class="forms-sample" action="{{url('/tambahpengeluaran')}}" method="post">{{csrf_field()}}
                                <div class="date-picker-inner">
                                    ...
                                    <div class="form-group data-custon-pick" id="data_2">
                                        <label>Kategori Pengeluaran</label>
                                          ...
                                          <select name="idkategori" tabindex="-1" class="form-control" required="" data-placeholder="Pilih Kelas">
                                              <option value="">--Pilih Kategori--</option>
                                              @foreach($j as $index => $kat)
                                                <option value="{{$kat->id_katpengeluaran}}">{{$kat->katpengeluaran}}</option>
                                              @endforeach
                                          </select>
                                    ...
                                    <div class="form-group data-custon-pick" id="data_2">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input name="kegunaan" class="form-control" required="" type="text" placeholder="*Kegunaan">
                                        </div>
                                    </div>
                                    <div class="form-group data-custon-pick" id="data_2">
                                        <label>Nominal</label>
                                        <div class="input-group date">
                                            ...
                                            <input name="nominal" class="form-control" required="" type="number" placeholder="*Nominal">
                                        </div>
                                    </div>
                                    <div class="form-group data-custon-pick" id="data_2">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input name="tanggal" class="form-control" required="" type="date" placeholder="*Tanggal">
                                        </div>
                                    </div>
                                    <div class="form-group data-custon-pick" id="data_2">
