                              ...
                              <div class="date-picker-inner">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="chosen-select-single mg-b-20">
                                      ...
                                      <div class="input-group date">
                                          <span class="input-group-addon"><i class="fa fa-money" aria-hidden="true"></i></span>
                                          <input type="number"class="form-control" id="fname" onkeyup="myFunction()" required>
                                      </div>
                                  </div>
                                    ...
                                    <div class="date-picker-inner">
                                        ...
                                        <div class="chosen-select-single mg-b-20">
                                            <label>Nama Bulan</label>
                                              ...
                                              $tarif = App\TarifBulanModel::where('id_bulan',$bl->id_bulan)->where('id_jenispayment',$data->id_jenispayment)->where('id_kelas',$kelas)->where('idsekolahtarif',$id)->count();
                                              if($tarif > 0){
                                                $tr = App\TarifBulanModel::where('id_bulan',$bl->id_bulan)->where('id_jenispayment',$data->id_jenispayment)->where('id_kelas',$kelas)->where('idsekolahtarif',$id)->first();
                                                $idtarif  = $tr->id_tarifbulan;
