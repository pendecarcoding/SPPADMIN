            ...
            <table id="example1" class="table table-bordered table-striped table-responsive">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{url("/payment/bulanan/$idpay")}}" class="btn btn-danger"><i class="fa fa-cog"></i></a></td>
                  @endif
                  @if($value->tipe=='Bebas')
                  <a href="{{url("/payment/bebas/$idpay")}}" class="btn btn-warning"><i class="fa fa-cog"></i></a></td>
                 @endif
                <td>


                  <a href="{{url("/payment/jenis_pay/edit/$idpay")}}" class="btn btn-warning"> <i class="fa fa-pencil"></i> Edit</a>
              ...
              <script>
                  ...
                  function(){   swal("data dihapus!", "", "success")
                      window.location = '{{url("deletepay")}}/'+id;
          ...
          <div class="box-header">
            <div class="sparkline16-hd">
                <div class="main-sparkline16-hd">
                    <center><h3>Tambah Tarif Umum</h3></center><hr>
                </div>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="sparkline16-list responsive-mg-b-30">
                          ...
                          <div class="sparkline16-graph">
                            <form class="form" action="{{url('/tambahpayment')}}" method="post">{{csrf_field()}}
