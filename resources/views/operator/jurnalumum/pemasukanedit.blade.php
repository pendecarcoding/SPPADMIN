        ...
        <div class="box">
          <div class="box-header">
            <div class="main-sparkline16-hd">
                <a href="{{url('/jurnalumum/pemasukan/')}}"style="float:right;" class="btn btn-danger">X</a>
                <center><h3>Edit Data Pemasukan</h3></center>
                <hr>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="sparkline16-graph">
                            <form class="forms-sample" action="{{url('/updatesumber')}}" method="post">{{csrf_field()}}
                              <div class="date-picker-inner">
                                  ...
                                  <div class="form-group data-custon-pick" id="data_2">
                                      ...
                                      <div class="input-group date">
                                          ...
                                          <input type="hidden" name="id" value="{{$e->id_pemasukan}}">
                                          <input style="background-color:#3e3e3e;color:white;" type="text" value="{{$e->sumber}}" name="dana" class="form-control" placeholder="*Sumber Dana" required>
                                      </div>
                                  </div>
                                  <div class="form-group data-custon-pick" id="data_2">
                                      <label>Nominal</label>
                                      <div class="input-group date">
                                          ...
                                          <input style="background-color:#3e3e3e;color:white;" type="number" value="{{$e->nominal}}" name="nominal" class="form-control" placeholder="*Nominal" required>
                                      </div>
                                  </div>
                                  <div class="form-group data-custon-pick" id="data_2">
                                      ...
                                      <div class="input-group date">
                                          ...
                                          <input style="background-color:#3e3e3e;color:white;" type="date" name="tanggal" value="{{$e->tanggal}}" class="form-control" placeholder="*Tanggal" required>
                                      </div>
                                  </div>
