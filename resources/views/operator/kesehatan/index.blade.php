                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Form Data Kesehatan Siswa</h4>
                        </div>
                        <div class="modal-body">
                            <form action="{{ url('addinfokesehatan') }}" method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label>Keterangan Kesehatan</label>
                                    <textarea name="keterangan" class="form-control" style="height: 200px;"
                                        required></textarea>
                                </div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                ...
                                                style="width: 95.35px;">Kesehatan Siswa</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1" aria-label="No Hp: activate to sort column ascending"
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Form Update Data Kesehatan Siswa</h4>
                        </div>
                        <div class="modal-body">
                            <form action="{{ url('updateinfokesehatan') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Keterangan Kesehatan</label>
                                    <textarea name="keterangan" class="form-control" style="height: 200px;width:500px;"
                                        required>{{ $v->kesehatan }}</textarea>
                                </div>
                  ...
                  function(){   swal("data dihapus!", "", "success")
                      window.location = '{{url("delkesehatan")}}/'+id;
