        ...
        <div class="box">
          <div class="box-header">
            <div class="main-sparkline16-hd">
                <center><h3>Tambah Data Kebijakan</h3></center>
                <hr>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="sparkline16-graph">
              <form class="forms-sample" action="{{url('/tambahkebijakan')}}" method="post">{{csrf_field()}}
                            ...
                            <label>Kebijakan</label>
                              <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-file" aria-hidden="true"></i></span>
                                  <input name="keb" class="form-control" required="" type="text" placeholder="*Kebijakan">
                              </div>
                        </div>
