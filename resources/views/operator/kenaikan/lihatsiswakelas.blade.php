...
<!-- Content Wrapper. Contains page content -->
            ...
            <div class="sparkline16-list responsive-mg-b-30">
                          <div class="sparkline16-hd">
                              <div class="main-sparkline16-hd">
                                  <h4>Data Kenaikan Kelas</h4>
                              </div>
                          </div>
                          <div class="sparkline16-graph">
                            <form class="forms-sample" action="{{url('/kenaikan/lihatsiswakelas/')}}" method="post">{{csrf_field()}}
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
    <div class="box">
     <div class="box-body">
        <form class="forms-sample" action="{{url('/aksinaikkelas')}}" method="post">{{csrf_field()}}
                                  <div class="sparkline16-list responsive-mg-b-30">
                                      <div class="sparkline16-hd">
                                          <div class="main-sparkline16-hd">
                                      ...
                                      <div class="sparkline16-graph">
                                          ...
                                          <div class="date-picker-inner">
                                              ...
                                              <div class="form-group data-custon-pick" id="data_2">
                                                ...
                                                <div class="chosen-select-single mg-b-20">
                                                    <label>Tahun Ajaran Selanjutnya</label>
                                              ...
                                              <div class="form-group data-custon-pick data-custom-mg" id="data_5">
                                                ...
                                                <button type="submit" class="btn btn-success widget-btn-1 btn-sm"><i class="fa fa-proses"></i> Proses Naik</button>
                                              </div>
